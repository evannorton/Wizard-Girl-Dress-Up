...
components.push(new Component("white-underwear", layers[0], 36, 56, 34, 97));
components.push(new Component("bikini-bottom", layers[0], 72, 56, 35, 100));
components.push(new Component("spats", layers[0], 108, 96, 22, 94));
components.push(new Component("black-bra", layers[0], 0, 8, 27, 47));
components.push(new Component("white-bra", layers[0], 36, 8, 27, 47));
components.push(new Component("corset", layers[0], 144, 8, 27, 61));
components.push(new Component("sports-bra", layers[0], 36, 96, 27, 47));
components.push(new Component("swimsuit", layers[0], 108, 8, 27, 47));
components.push(new Component("bikini-top", layers[0], 72, 8, 27, 47));
...
componentPieces.push(new ComponentPiece("black-underwear-back", components[0], 1));
componentPieces.push(new ComponentPiece("black-underwear-front", components[0], 5));
componentPieces.push(new ComponentPiece("white-underwear-back", components[1], 1));
componentPieces.push(new ComponentPiece("white-underwear-front", components[1], 5));
componentPieces.push(new ComponentPiece("bikini-bottom-back", components[2], 1));
componentPieces.push(new ComponentPiece("bikini-bottom-front", components[2], 5));
componentPieces.push(new ComponentPiece("spats-back", components[3], 1));
componentPieces.push(new ComponentPiece("spats-front", components[3], 5));
componentPieces.push(new ComponentPiece("black-bra-back", components[4], 1));
componentPieces.push(new ComponentPiece("black-bra-front", components[4], 5));
componentPieces.push(new ComponentPiece("white-bra-back", components[5], 1));
componentPieces.push(new ComponentPiece("white-bra-front", components[5], 5));
componentPieces.push(new ComponentPiece("corset-back", components[6], 1));
componentPieces.push(new ComponentPiece("corset-front", components[6], 5));
componentPieces.push(new ComponentPiece("sports-bra-back", components[7], 1));
componentPieces.push(new ComponentPiece("sports-bra-front", components[7], 5));
componentPieces.push(new ComponentPiece("swimsuit-back", components[8], 1));
componentPieces.push(new ComponentPiece("swimsuit-front", components[8], 5));
componentPieces.push(new ComponentPiece("bikini-top", components[9], 6));
// componentPieces.push(new ComponentPiece("pads-front", components[2], 8));
// componentPieces.push(new ComponentPiece("pads-back", components[2], 1));
// componentPieces.push(new ComponentPiece("sleeves-front", components[4], 8));
// componentPieces.push(new ComponentPiece("sleeves-back", components[4], 1));
// componentPieces.push(new ComponentPiece("maid-front", components[5], 8));
// componentPieces.push(new ComponentPiece("maid-back", components[5], 1));
// componentPieces.push(new ComponentPiece("hat", components[6], 9));
// componentPieces.push(new ComponentPiece("long-hair", components[7], 9));
// componentPieces.push(new ComponentPiece("short-hair", components[8], 9));
// componentPieces.push(new ComponentPiece("socks", components[9], 6));
// componentPieces.push(new ComponentPiece("garder", components[10], 6));
// componentPieces.push(new ComponentPiece("sunglasses", components[11], 3));
