...
ngio.getValidSession(() => {
    ...
    const render = () => {
        ...
        creditsElement.style.left = getPX(177);
        ...
        const firstLinkWidth = retrommoFirst ? 43 : 29;
        const secondLinkWidth = retrommoFirst ? 29 : 43;
        firstLinkElement.style.top = getPX(130);
        firstLinkElement.style.left = getPX(237);
        ...
        secondLinkElement.style.left = retrommoFirst ? getPX(306) : getPX(292);
